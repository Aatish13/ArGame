...
namespace GoogleARCore.Examples.AugmentedFaces
{
    ...
    public class ARCoreAugmentedFaceRig : MonoBehaviour
    {
        ...
        public void Update()
        {
            ...
            _UpdateRegions();
             string[] aThought=new string[7]{"Thoughts become things.","Nothing can harm you as much as your own thoughts unguarded."
        ...
        private string filterString(string temp)
        {
            string ans = "";
            int i=0;
